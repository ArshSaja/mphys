...
class Model(Multipoint):
    def setup(self):
        ...
        structure_setup = {"panel_chord": panel_chord, "panel_width": panel_width, "N_el": N_el_struct}

        struct_builder = StructBuilder(structure_setup)
        struct_builder.initialize(self.comm)

        # aero builder
        aero_setup = {"panel_chord": panel_chord, "panel_width": panel_width, "N_el": N_el_aero}
